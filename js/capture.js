function capture() {
  const capture = {
    Capture : {
      Amount : document.querySelector('#captureAmount').value,
      Currency : document.querySelector('#captureCurrency').value,
      TransactionID : document.querySelector('#captureTransactionID').value,
      Customer : document.querySelector('#captureCustomerId').value,
      UserName : document.querySelector('#captureUserName').value,
      Password : document.querySelector('#capturePassword').value
    }
  }
  ...
  xhttp.send(JSON.stringify(capture));
}