function rp() {
  const rp = {
    Registration : {
      Customer : document.querySelector('#rpCustomerId').value,
      Language : document.querySelector('#rpLanguage').value,
      OrderName : document.querySelector('#rpOrderName').value,
      OrderID : document.querySelector('#rpOrderID').value,
      Amount : document.querySelector('#rpAmount').value,
      Currency : document.querySelector('#rpCurrency').value,
      Recurrence : {
        Type : document.querySelector('#rpRecurrenceType').value
      },
      OrderInfo : document.querySelector('#rpOrderInfo').value,
      TransactionHint : document.querySelector('#rpTransactionHint').value,
      ReturnPath : document.querySelector('#rpReturnPath').value
    }
  }
